...
s.shunt_rc("RK1A", "2.7k", "CK1A", "25u", 60, BY + 10)
...
s.wire(92, BY + 10, 92, BY + 18)          # NA -> the cathode load's own top pin
...
s.shunt_rc("RK2A", "1.5k", "CK2A", "25u", 60, NY0 + 10)
s.plate_load("RL2A", "100k", t2a["p"], "BP355")
P2A_Y = NY0 - 7.62 - 3.48
s.junction(54, P2A_Y)
...
s.shunt_rc("RK2B", "2.7k", "CK2B", "25u", 196, NY0 + 10)
...
s.junction(t3a["g"][0] - 3.81, DY)
s.wire(240, DY + 7.62, 240, DY + 10)
s.wire(240, DY + 10, 246, DY + 10)
s.shunt_r("RK3A", "1.5k (est)", 246, DY + 10)
...
s.junction(t3b["g"][0] - 3.81, DY)
s.wire(296, DY + 7.62, 296, DY + 10)
s.wire(296, DY + 10, 302, DY + 10)
s.shunt_r("RK3B", "1.5k", 302, DY + 10)
...
TAIL_X = JY + 60
TAIL_Y = PIY_A + 10 + 30
s.wire(354, PIY_B + 10, 354, 250)
s.sym("R", "RTAIL", "820", 354, 253.81)
s.wire(354, 257.62, 354, 262)
s.wire(354, 262, 320, 262)
s.wire(320, 262, 320, TAIL_Y)
s.junction(320, TAIL_Y)
...
s.wire(TAIL_X - 14, NFB_Y, fr, NFB_Y)
s.wire(fl, NFB_Y, TAIL_X - 30, NFB_Y)
s.glabel("SPKR", TAIL_X - 30, NFB_Y, 180)
...
s.wire(GL, PIY_B, GL, PIY_B + 8)
s.sym("R", "RG4B", "1M", GL, PIY_B + 11.81, lx=2.6)
s.wire(GL, PIY_B + 15.62, GL, PIY_B + 20)
s.wire(GL, PIY_B + 20, 334, PIY_B + 20)
s.wire(334, PIY_B + 20, 334, TAIL_Y)
s.wire(GL, PIY_B, t4b["g"][0], PIY_B)
s.wire(RC, TAIL_Y, 334, TAIL_Y)
s.wire(RC, TAIL_Y, TAIL_X, TAIL_Y)
s.junction(RC, TAIL_Y)
s.junction(334, TAIL_Y)
...
s.wire(t5["g1"][0] - 3.81, PIY_A, t5["g1"][0], PIY_A)
...
s.wire(t6["g1"][0] - 3.81, PIY_B, t6["g1"][0], PIY_B)
...
s.wire(t5["p"][0], t5["p"][1], t5["p"][0], 186)
s.wire(t5["p"][0], 186, 461.11, 186)
s.wire(461.11, 186, 461.11, 212.92)
s.wire(t6["p"][0], t6["p"][1], t6["p"][0], 223.08)
s.wire(t6["p"][0], 223.08, 461.11, 223.08)
s.wire(461.11, 218, 452, 218)
s.glabel("BP428", 452, 218, 180)
s.wire(478.89, 215.46, 486, 215.46)
s.glabel("SPKR", 486, 215.46, 0)
s.wire(478.89, 220.54, 486, 220.54)
s.glabel("GND", 486, 220.54, 0)
...
dl2, dr2 = s.series_h("R", "RD1", "4.7k 1W", 106, PY + 40)
...
s.sym("C", "C12", "20u 600V", 182, PY + 43.81)
s.gnd(182, PY + 47.62)
s.junction(182, PY + 40)
s.wire(176, PY + 40, 182, PY + 40)
s.wire(182, PY + 40, 182, PY + 34)
s.glabel("BP410", 182, PY + 34, 90)
s.junction(156, PY + 40)
s.wire(156, PY + 40, 156, PY + 52)   # not down x=150: that lane runs through C11
dl6, dr6 = s.series_h("R", "RD3", "56k 1W", 164, PY + 52)
s.wire(156, PY + 52, dl6, PY + 52)
...
s.gnd(292, BSY)
s.wire(270, BSY, 270, BSY - 8)
s.glabel("NBIAS", 270, BSY - 8, 90)
