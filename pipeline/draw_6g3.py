...
# into the same bus (the pin at YPB - 7.62 is the PLATE; taking the tail there
# put the tail resistor on the cold plate node and left V3B's cathode floating).
