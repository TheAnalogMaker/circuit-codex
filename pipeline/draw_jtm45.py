...
s.sym("DIODE_SS", "D1", "1N4007", 158.99, 172.72, lx=-2.0, ly=-5.4)
s.wire(164.07, 172.72, 167.88, 172.72)
l, r = s.series_h("R", "RB1", "150k", 171.69, 172.72)
s.wire(167.88, 172.72, l, 172.72)
s.wire(r, 172.72, 183.12, 172.72)
s.junction(178.04, 172.72)
s.sym("C", "C15", ".05u", 178.04, 176.53)
s.gnd(178.04, 180.34)
s.junction(180.58, 172.72)
s.sym("C", "C16", "25u", 180.58, 176.53, lx=2.2)
s.gnd(180.58, 180.34)
s.glabel("-50V", 183.12, 172.72, 0)
