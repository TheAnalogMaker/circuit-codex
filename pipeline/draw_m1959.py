...
s.wire(156, 133.62, 156, 138)              # treble pot bottom joins bass top
...
s.wire(156, 155.62, 156, 158)
s.sym("C", "C10", ".022u", 156, 161.81)
s.gnd(156, 165.62)
