...
s.junction(121, 119.5)
s.wire(121, 119.5, 121, 94)            # node A up to the 250 pF branch
s.wire(121, 94, 140.19, 94)
tl, tr = s.series_h("C", "C5", "250p", 144, 94)
s.wire(tr, 94, 152.4, 94)
s.sym("POT", "VR3", "250k treb", 152.4, 97.81)
# node B -> 0.02 uF to the treble-bottom/bass-top node, and to the mid wiper
s.junction(137, 119.5)
s.wire(137, 119.5, 137, 104)
bl, br = s.series_h("C", "C6", ".02u", 144, 104)
s.wire(137, 104, bl, 104)
s.wire(br, 104, 152.4, 104)
s.junction(152.4, 104)
...
s.wire(152.4, 101.62, 152.4, 106)
s.sym("POT", "VR4", "1M bass", 152.4, 109.81)
s.wire(157.48, 109.81, 166, 109.81)     # bass wiper tied to its top (rheostat)
