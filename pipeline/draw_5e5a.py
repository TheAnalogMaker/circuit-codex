...
tcl, tcr = s.series_h("C", "C7", ".01u", 112, 84)
s.wire(tcr, 84, 122, 84)
s.sym("POT", "VR4", "1M treble", 122, 87.81)          # top pin (122, 84)
s.sym("C", "C8", ".0005u", 122, 95.43)              # top pin (122, 91.62) == VR4 bottom pin
...
# VR5 (Presence, 5k, other lug grounded) -> wiper -> C9 .1-200 -> driver
...
ncl, ncr = s.series_h("C", "C9", ".1u", 196, 63.81)
